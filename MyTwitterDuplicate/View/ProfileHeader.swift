...
class ProfileHeader: UICollectionReusableView {
    ...
    lazy var editProfileFollowButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleEditingProfileFollow), for: .touchUpInside)
        return button
    }()
    ...
    private let bioLabel: UILabel = {
        ...
        label.text = "This is a user bio, that will span more than one line for test perposes"
        return label
    }()
    ...
    @objc func handleEditingProfileFollow() {
        delegate?.handleEditingProfileFollow(self)
    }
